...
<img width="1018" height="265" alt="image" src="https://github.com/user-attachments/assets/c5d810e5-1798-474e-8d9a-3ae9b8d1f063" />
You can refer this page to understand the design and flow of the code - Code design
The beauty of designing a code is, you can use them for other data as well, I have populated some extra data for Indian industry entertainers, which I didn't use it in this project. You can find the sql dump in this page SQL dump.
...
Architecture 🪵
<img width="1084" height="498" alt="image" src="https://github.com/user-attachments/assets/472c1911-24d3-421a-a220-8e6242038614" />
